...
class ViewController: UIViewController {
    @IBOutlet var defaultBannerButton: UIButton!
    @IBOutlet var imageBannerButtonTopConstraint: NSLayoutConstraint!
    ...
    @IBAction func showSimpleBanner(_: UIButton) {
    ...
    @IBAction func showDefaultBanner(_: UIButton) {
        tableView.frame = CGRect(x: defaultBannerButton.frame.origin.x, y: defaultBannerButton.frame.origin.y + defaultBannerButton.frame.height, width: defaultBannerButton.frame.width, height: 0)
    ...
    @IBAction func showCustomBanner1(_: UIButton) {
    ...
    @IBAction func showCustomBanner2(_: UIButton) {
    ...
    @IBAction func showCustomBanner3(_: UIButton) {
    ...
    @IBAction func showCustomBanner4(_: UIButton) {
    ...
    @IBAction func showCustomBanner5(_: UIButton) {
    ...
    @IBAction func showCustomBanner6(_: UIButton) {
...
extension ViewController {
    func getTraitColor() -> UIColor {
        return UIColor { traits -> UIColor in
            return traits.userInterfaceStyle == .light ? .white : UIColor(red: 28 / 255, green: 27 / 255, blue: 29 / 255, alpha: 1)
        }
    }
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            banner = SYDefaultBanner("This is a custom banner with an icon. Try it out yourself 🔥", icon: image, backgroundColor: UIColor(red: 28 / 255, green: 27 / 255, blue: 29 / 255, alpha: 1), direction: .top)
            banner?.messageColor = .white
